...
function ServiceCard({ servizio }) {
  return (
    <article className="flex h-full flex-col gap-3 rounded-[4px] border border-grigio-chiaro p-6 transition-[transform,border-color] duration-200 ease-out hover:-translate-y-1 hover:border-fucsia">
